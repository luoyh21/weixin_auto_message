...
SYS_SOCIAL = (
    ...
    "上的帖子原文（英文为主）。判定口径要**放宽**：只要内容**涉及航天 / 太空**，无论是技术、商业、"
    "政策还是人事，都算相关（relevant=true）。包括但不限于：\n"
    "  · 火箭 / 卫星 / 飞船 / 空间站 / 星舰(Starship) / 星链(Starlink) / 载人航天 / 宇航员；\n"
    "  · 登月 / 火星 / 深空探测 / 行星科学 / 太空望远镜；\n"
    "  · NASA / SpaceX / 蓝色起源 / 各国航天机构、商业航天公司及其动态；\n"
    "  · 太空军(Space Force) / 太空国防 / 反卫星 / 太空态势感知；\n"
    "  · 航天相关的政策、立法、预算、拨款、监管(FAA/FCC)、国际合作或竞争；\n"
    "  · 火箭发射、试飞、事故、里程碑等事件。\n"
    "**只有**与航天 / 太空毫无关系的内容（如纯国内政治骂战、媒体口水、体育、移民、关税、"
    "无实质文字的表情或『Video』『Wow』之类）才填 relevant=false。\n"
